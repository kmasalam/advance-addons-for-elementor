 ...
 */
namespace AAFE\Elementor\Controls;
...
class Group_Control_Foreground extends Group_Control_Base {
     ...
     *
     * Retrieve the control type, in this case `Advance_Addons_text_color`.
     *
     * @since 1.0.0
     * @access public
     * @static
    ...
    public function init_fields() {
        ...
        $fields['color_type'] = [
            ...
            'options' => [
                'classic' => [
                    'title' => _x( 'Classic', 'Text Color Control', 'advanced-addons-elementor' ),
                    'icon' => 'fa fa-paint-brush',
                ],
                'gradient' => [
                    'title' => _x( 'Gradient', 'Text Color Control', 'advanced-addons-elementor' ),
                    'icon' => 'fa fa-barcode',
                ],
            ],
            'default' => 'classic'
